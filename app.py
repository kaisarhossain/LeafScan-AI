"""Non-MCP Streamlit version for HF deployment to integrate to FastAPI server directly in the same HF space."""
...
# Auto-start FastAPI in background (HF Spaces)
if 'fastapi_started' not in st.session_state:
    if os.getenv('SPACE_ID'):  # Only in HF Spaces
        subprocess.Popen([
            "uvicorn",
            "fastapi_server:app",
            "--host", "0.0.0.0",
